...
export const guruQuizApi = {
  ...
  results: (paketId: number, kelasSenseiId?: number) => api.get(`/guru/quiz/pakets/${paketId}/results`, { params: { kelas_sensei_id: kelasSenseiId } }),
  monitor: (paketId: number, date?: string, kelasSenseiId?: number) => api.get(`/guru/quiz/pakets/${paketId}/monitor`, { params: { date, kelas_sensei_id: kelasSenseiId } }),
  leaderboard: () => api.get('/guru/quiz/leaderboard'),
