      ...
      {locked ? (
        ...
        <div className="mt-2 flex items-center gap-3">
          <button
            type="button"
            onClick={togglePlay}
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#0E6187] text-white shadow transition hover:bg-[#0c4f70]"
          ...
          <div className="min-w-0 flex-1">
            <div className="h-2 w-full overflow-hidden rounded-full bg-[#e6f2f8]">
              <div className="h-full rounded-full bg-[#0E6187] transition-[width] duration-200" style={{ width: `${progress * 100}%` }} />
            </div>
