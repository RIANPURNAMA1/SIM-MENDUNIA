        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <button onClick={() => setPaused(p => !p)}
              className={`flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-[10px] font-bold transition-colors ${paused ? 'bg-[#0E6187]/20 text-[#7ec3e4]' : 'bg-white/5 text-slate-300 hover:bg-white/10'}`}>
